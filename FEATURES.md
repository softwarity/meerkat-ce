...
| [~] | MODEL-02 | **Fenêtre de validité** | Un compte porte ses dates d'accès (du / jusqu'au), en **jours et non en instants** : « jusqu'au 31 » vaut tout le 31. Hors fenêtre, la connexion est refusée en nommant la date, et la session en cours comme le plan de données le revérifient - un compte qui sort de sa fenêtre n'ouvre plus rien, sans que personne soit déconnecté en plein travail par une horloge | le résumé quotidien par e-mail aux administrateurs, sur les comptes qui expirent et ceux qui viennent d'expirer (conditionné au SMTP) | CE |
