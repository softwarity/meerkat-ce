...
// The Performance page renders the LATEST benchmark the CI ran (tools/bench,
// ci.yml "Benchmark"). It is fetched on every visit, not built in: the CI
// rewrites latest.json on the `bench` branch of the community mirror after
// each commit to main, so the page follows the code without a redeploy.
